...
$(document).ready(function() {
    $('#sample_1').DataTable({
        ...
        "ordering": false, // 禁止排序
        // "sDom": '<"top"fli>rt<"bottom"p><"clear">', // 每页显示数量
...
$(document).ready(function() {
    ...
    $('#sample_2').DataTable({
        ...
        "data": [{
            "name": "张三",
            "Sex": "男",
            "img": "<img src='https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2699257375,1716518260&fm=117&gp=0.jpg'width='30' height='30' class='img-circle'>",
            "bumen": "研发部",
            "zhiwei": "程序",
            "phone": "1388888888",
            "nub": "44444444444444",
            "time": "2017-07-07",
            "del": "<button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-target='#bianji' style=' ;background-color: #1E35D5 ;font-size:12px;line-height: 6px;margin-right:10px;' value='编辑'> 编辑 </button> <button type='button' class='btn btn-primary btn-lg'  id='delrow' data-toggle='modal' data-target='#del' style='background-color: red;font-size:12px;    line-height: 6px;    border-color: red;' id='myStateButton'> 删除 </button>",
        }, ],
        ...
        "render": function(data, type, row) {
            ...
            return "<button class='btn btn-danger' id='del' name='del' style='margin-left:10px;'>删除</button>";
